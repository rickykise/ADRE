...
//        let opx:String? = defaults.string(forKey: "log")
...
//                // 인트로 화면 이동...
//                let storyboard = UIStoryboard(name: "Main", bundle: nil)
//                let intro = storyboard.instantiateViewController(withIdentifier: "mainView")
//
//                self.window?.rootViewController = intro
//                self.window?.makeKeyAndVisible()
//            }
...
//
//        // 값 저장 (키 값)
//        defaults.setValue("second", forKey: "log")
//        // 동기화
...
//        print("프론트그라운드")
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "ADRE")
